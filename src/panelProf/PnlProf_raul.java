...
public class PnlProf_raul  extends JPanel{

    public static PnlProf_raul pnlProf = new PnlProf_raul(); // se crea la variable que se instanciará desde fuera

    /**
     * Constructor del panel el cual llamara al metodo {@link establecerVentana}
     */
    private PnlProf_raul(){
    ...
    public void establecerVentana(){
        ...
        /**{@link JPanel} que va a guardar todos los elementos propios del panel, con los que se va a interactuar */
